...
SUBJECTS={'sub-pt-NDARBC584LZQ','sub-pt-NDARBJ075TLE','sub-pt-NDARCL005MMD',...
    'sub-pt-NDARGV601CDG','sub-pt-NDARMB411WNJ',...
    'sub-pt-NDARNK126VXX','sub-pt-NDARNR712HLD',...
    'sub-pt-NDARRC609XA1','sub-pt-NDARRU795MHN',...
    'sub-pt-NDARTK790VYB','sub-pt-NDARUU945HT5',...
    'sub-pt-NDARYH931XPC','sub-pt-NDARZE250LYA','sub-pt-NDARZX654AAE'}; % subjects with phase bins
...
for sub = 1:length(SUBJECTS)
    ...
    IndexC = strfind(HLPLLPphase.SUBJECTS,id);
    Index = find(not(cellfun('isempty',IndexC)));
